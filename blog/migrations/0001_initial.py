# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-03-22 03:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(upload_to='tu', verbose_name='推广图片')),
                ('title', models.TextField(blank=True, verbose_name='推广文案')),
                ('url', models.URLField(verbose_name='推广链接')),
            ],
            options={
                'verbose_name': '推广素材',
